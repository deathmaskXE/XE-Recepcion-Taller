...
$("crear").onclick=async()=>{
  try{
    ...
    const pub={equipo:d.equipo,modelo:d.modelo,nota:d.nota,estado:d.estado,recibido:d.recibido,actualizado:d.actualizado,entregado:d.entregado,garantiaTiempo:d.garantiaTiempo,garantiaUnidad:d.garantiaUnidad,garantiaHasta:d.garantiaHasta};
    ...
    ["cliente","telefono","equipo","modelo","falla","nota"].forEach(x=>$(x).value="");$("garantiaTiempo").value="30";$("garantiaUnidad").value="dias";
  }catch(e){
    console.error(e);
